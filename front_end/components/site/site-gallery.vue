        ...
        <div class="site-gallery">
            <div class="site-gallery-header">
                <div class="site-gallery-header-heading">
                    ...
                    <router-link
                        tag="div"
                        class="button gallery-header-button"
                        to="/"
                    ><i class="fal fa-times"></i></router-link>
            </div>
                ...
                <div class="site-gallery-content-scroll-area" data-simplebar>
                    <div class="site-gallery-content">
                        <router-link
                            ...
                            v-bind:key="image.id"
                            tag="div"
                            class="site-gallery-item-container"
                            v-bind:to="'/gallery/' + $route.params.name + '/image/' + image.id"
                            >
